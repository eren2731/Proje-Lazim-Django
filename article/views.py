...
def index(request):
    ...
    nasilcalisiyoruz=Article.objects.get(title="nasilcalisiyoruz")
    return render(request,"index.html", {"products":products,"comments":comments,"ic_an1":ic_an1,"ic_an2":ic_an2,"ic_an3":ic_an3,"ic_an4":ic_an4, "nasilcalisiyoruz":nasilcalisiyoruz })
...
def elektrik(request):
    ...
    elektrik_an1=Article.objects.get(title="elektrik_an1")
    elektrik_an2=Article.objects.get(title="elektrik_an2")
    elektrik_an3=Article.objects.get(title="elektrik_an3")
    elektrik_an4=Article.objects.get(title="elektrik_an4")
    nasilcalisiyoruz=Article.objects.get(title="nasilcalisiyoruz")
    return render(request,"elektrik.html", {"products":products,"comments":comments,"elektrik_an1":elektrik_an1,"elektrik_an2":elektrik_an2,"elektrik_an3":elektrik_an3,"elektrik_an4":elektrik_an4, "nasilcalisiyoruz":nasilcalisiyoruz })
...
def mekanik(request):
    ...
    mekanik_an1=Article.objects.get(title="mekanik_an1")
    mekanik_an2=Article.objects.get(title="mekanik_an2")
    mekanik_an3=Article.objects.get(title="mekanik_an3")
    mekanik_an4=Article.objects.get(title="mekanik_an4")
    nasilcalisiyoruz=Article.objects.get(title="nasilcalisiyoruz")
    return render(request,"mekanik.html", {"products":products,"comments":comments,"mekanik_an1":mekanik_an1,"mekanik_an2":mekanik_an2,"mekanik_an3":mekanik_an3,"mekanik_an4":mekanik_an4, "nasilcalisiyoruz":nasilcalisiyoruz })
...
def yazilim(request):
    ...
    yazilim_an1=Article.objects.get(title="yazilim_an1")
    yazilim_an2=Article.objects.get(title="yazilim_an2")
    yazilim_an3=Article.objects.get(title="yazilim_an3")
    yazilim_an4=Article.objects.get(title="yazilim_an4")
    nasilcalisiyoruz=Article.objects.get(title="nasilcalisiyoruz")
    return render(request,"yazilim.html", {"products":products,"comments":comments,"yazilim_an1":yazilim_an1,"yazilim_an2":yazilim_an2,"yazilim_an3":yazilim_an3,"yazilim_an4":yazilim_an4, "nasilcalisiyoruz":nasilcalisiyoruz })
